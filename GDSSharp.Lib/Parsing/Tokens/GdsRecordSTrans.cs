...
public class GdsRecordSTrans : IGdsRecord
{
    ...
    public void Read(GdsBinaryReader reader, GdsHeader header)
    {
        ...
        {
            throw new ArgumentException($"The number of bytes to read for a STrans record should be 2, but was {header.NumToRead}.");
        }
