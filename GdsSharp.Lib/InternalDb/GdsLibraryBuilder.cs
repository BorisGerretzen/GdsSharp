...
public class GdsLibraryBuilder(IGdsVertexStoreWriter vertexWriter)
{
    ...
    public int AddStructureReference(GdsElementCommon common, string targetName, GdsStransInfo? strans, GdsPoint origin)
    {
        ...
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.SRef, _structureReferences.Count, null);
        ...
        GdsPoint origin)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.ARef, _arrayReferences.Count, null);
        _elements.Add(elementRecord);
    ...
    public int AddBoundary(GdsElementCommon common, short layer, short dataType, ReadOnlySpan<GdsPoint> points)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.Boundary, _boundaries.Count, GdsBoundingBox.FromPoints(points));
        _elements.Add(elementRecord);
    ...
    public int AddBox(GdsElementCommon common, short layer, short dataType, ReadOnlySpan<GdsPoint> points)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.Box, _boxes.Count, GdsBoundingBox.FromPoints(points));
        _elements.Add(elementRecord);
    ...
    public int AddPath(GdsElementCommon common, short layer, short dataType, ReadOnlySpan<GdsPoint> points, int? width, GdsPathType? pathType)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.Path, _paths.Count, boundingBox);
        _elements.Add(elementRecord);
    ...
    public int AddNode(GdsElementCommon common, short layer, short dataType, ReadOnlySpan<GdsPoint> points)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.Node, _nodes.Count, GdsBoundingBox.FromPoints(points));
        _elements.Add(elementRecord);
        ...
        string text)
    {
        ...
        var elementId = _elements.Count;
        var elementRecord = new ElementRecord(_currentStructureId.Value, common, ElementKind.Text, _texts.Count, null);
        _elements.Add(elementRecord);
