...
public static class CircleBuilder
{
    ...
    /// <returns>Array of points representing the circle polygon.</returns>
    public static GdsPoint[] CreateCirclePoints(int x, int y, int radius, int numPoints = 64)
    {
        if (numPoints % 8 != 0)
        ...
        void WriteSymmetricPoints(int xc, int yc, int px, int py)
        {
            pointsPerSector[0].Add(new GdsPoint(xc + px, yc + py));
            pointsPerSector[1].Add(new GdsPoint(xc + py, yc + px));
            pointsPerSector[2].Add(new GdsPoint(xc + py, yc - px));
            pointsPerSector[3].Add(new GdsPoint(xc + px, yc - py));
            pointsPerSector[4].Add(new GdsPoint(xc - px, yc - py));
            pointsPerSector[5].Add(new GdsPoint(xc - py, yc - px));
            pointsPerSector[6].Add(new GdsPoint(xc - py, yc + px));
            pointsPerSector[7].Add(new GdsPoint(xc - px, yc + py));
        }
    }
