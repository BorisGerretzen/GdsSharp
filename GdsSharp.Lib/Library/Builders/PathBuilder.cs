...
public class PathBuilder
{
    ...
    /// <param name="initialHeading">Initial heading direction (default: UnitY).</param>
    ...
    {
        if (maxVertices < 4)
            throw new ArgumentException("maxVertices must be at least 4 to form a valid polygon.", nameof(maxVertices));
